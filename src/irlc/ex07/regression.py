...
def solve_linear_problem_simple(Y, X, U, lamb=0): #!s=a
    ...
    A is n x n dimensional, Y is n x N dimensional, X is n x N dimensional, and so on (i.e. observations are in the horizontal dimension). #!s
    """
