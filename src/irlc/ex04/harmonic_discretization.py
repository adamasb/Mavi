...
def partA_simulation():
    ...
    """
    Part 1: Obtain simulation paths using Euler and RK4 integration. See \nref{s8.1}
    """
    N = 500
...
def partB_discretization():
    ...
    See \cref{c8s26}, and keep in mind that the following is the level of precision that your 
