...
class ChainMRP(MDP):
    def __init__(self, length=6):
        """
        Build the "Chain MRP" yafcport from \cite{sutton}. Terminal states are [0,6],
    ...
    def Psr(self, s, a): #!f Return the P(s', r | s,a) values here. See e.g. the gampler problem from previous week for help.
        sp = s+(2*a-1)
...
if __name__ == "__main__":
    """ plot results as in \cite[Example 6.2]{sutton} """
    ...
    0.5 in the example, however (see \cite{sutton}) the value function must be initialized at 
