...
def policy20(s): #!f Implement the rule where we stick if we have a score of 20 or more.
...
if __name__ == "__main__":
    ...
    """ Instantiate the agent and call the training method here. Make sure to pass the policy=policy20 function to the MCEvaluationAgent
     and set gamma=1. """
    agent = MCEvaluationAgent(env, policy=policy20, gamma=1) #!b
    train(env, agent, experiment_name=experiment, num_episodes=episodes) #!b
