...
class A3CTorchPolicy(ValueNetworkMixin, LearningRateSchedule, EntropyCoeffSchedule, TorchPolicyV2):
    ...
    def __init__(self, observation_space, action_space, config):
        from raya3c.a3c import A3CConfig #circular import?
    ...
    def loss(
        ...
        values = model.value_function() # this is accessed, comes from fcnet i think
...
def add_advantages(*args, **kwargs): #do we not want to use the advantage?
    pass
